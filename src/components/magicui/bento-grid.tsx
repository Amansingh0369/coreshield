...
const BentoCard = ({
  ...
  <div
    ...
    className={cn(
      ...
      // light styles
      " [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)] bg-neutral-950",
      // dark styles
      "transform-gpu bg-white [border:1px_solid_rgba(255,255,255,.1)] [box-shadow:0_-20px_80px_-20px_#ffffff1f_inset] bg-neutral-950",
      className,
    )}
    {...props}
  >
